...
export default function CoursePlayer({
  ...
  return (
    <aside className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-lg p-4 sticky top-4">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-xs uppercase tracking-wider text-ink-500 dark:text-ink-400">
          Lessons
        </h3>
      ...
      <div className="h-1 w-full bg-ink-200 dark:bg-ink-700 rounded mb-3 overflow-hidden">
        <div
            ...
            <li key={l.order}>
              <Link
                ...
                className={
                  ...
                  (isCurrent
                    ? "bg-accent-subtle dark:bg-accent/20 text-accent-ink dark:text-accent font-medium"
                ...
                <span
                  className={
                    ...
                    (isDone
                      ...
                      : "border border-ink-300 dark:border-ink-600 text-ink-500 dark:text-ink-400")
                  }
                >
                  {isDone ? "✓" : l.order}
                </span>
